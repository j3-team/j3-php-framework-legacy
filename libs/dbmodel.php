   ...
   */
    ...
    */
    ...
    /** Asigna el valor dado al campo establecido. Se usa antes de un updateIt y SaveIt.
        ...
        @param value Valor a asignar. Si es una funci�n de BD, utilizar '%': (Ej. '%NOW()') 
    */
	...
	*/
	...
	/** Retorna el numero de filas afectadas por la operaci�n (INSERT, UPDATE, DELETE).
	@return int
	*/
